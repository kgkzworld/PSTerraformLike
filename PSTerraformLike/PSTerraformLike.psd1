...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Desired State Configuration','DSC','Terraforms','Terraform','YAML','YML','Configuration Management','CM','Infrastructure as Code','IaC','DevOps','Automation','Security','SecOps')
